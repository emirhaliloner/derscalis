        ...
        <div class="orta">
            <div class="ortaicerik">
                <form action="" method="post">
                    <h2 class="form-baslik">Aşağıdaki Alana Sorularınızı Yazabilirsiniz</h2>
                    <?php
                    ...
                    if(isset($_POST['soru'])){
                        ...
                        $id=$_SESSION['kid'];
                        $zaman=date("d M Y H:i:s");
                        $sql ="INSERT INTO soru_ekle (sid,soru,tarih,kid) VALUES('$yaz','$zaman','$id')";
                        $soru_id=$sql['sid'];
                        $_SESSION['soru_id']=$soru_id;
                        if($yaz=="") {
                            echo "<div style='background-color:#E71212;width:auto;height:auto;'>
				<p style='text-align:center;font-size:13pt'>Lütfen soru alanı doldurunuz.<img style='width:30px;height:30px' src='hata.png'/></div>";
                        }
				...
				<p style='text-align:center;font-size:13pt'>Kaydınız eklendi.<img style='width:30px;height:30px' src='onay.png'/></div>";
                    ...
                    <div class="login-wrap">
                        ...
                        Sorunuz: <textarea style='height:200px;padding-left:10px;resize:none;' type="text" class="form-control" placeholder="Sorularınızı Girebilirsiniz..." name="yaz"></textarea><br>
                        <button style='width:100px;background-color:#44CC3F' class="btn btn-theme btn-block" type="submit" name="soru"><i class="fa fa-lock">&nbsp;</i>Kaydet</button>
                    </div>
                </form>
                <br>
...
<footer class="site-footer">
    <div class="text-center">
        2016 - WebteDers
        <a href="soru_cevap.php" class="go-top">
